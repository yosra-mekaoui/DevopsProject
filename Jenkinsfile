    ...
    stages {
      ...
      stage('Mock and JUnit Tests') {
       ...
       stage('Publish to Nexus') {
                    steps {
                            sh 'mvn clean package deploy:deploy-file -DgroupId=tn.esprit -DartifactId=DevOps_Project -Dversion=2.1 -DgeneratePom=true -Dpackaging=jar -DrepositoryId=maven-releases -Durl=http://192.168.33.10:8081/repository/maven-releases/ -Dfile=target/DevOps_Project-2.1.jar'
                    }
                }
